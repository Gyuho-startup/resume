-- UK Resume Builder MVP - Initial Schema (FIXED)
-- Migration: 20250209000001_initial_schema_fixed.sql
-- Description: Core tables for resume builder, templates, exports, and purchases
-- FIX: Added template_slug column to resumes table
...
CREATE INDEX IF NOT EXISTS idx_templates_display_order ON public.templates(display_order);
...
CREATE TABLE IF NOT EXISTS public.resumes (
    ...
    template_slug TEXT NOT NULL DEFAULT 'education-first',
...
CREATE INDEX IF NOT EXISTS idx_resumes_role_slug ON public.resumes(role_slug);
CREATE INDEX IF NOT EXISTS idx_resumes_template_slug ON public.resumes(template_slug);
...
CREATE INDEX IF NOT EXISTS idx_purchases_pass_window ON public.purchases(pass_start_at, pass_end_at);
