...
/**
 * Sharp Geometric Template (slug: sharp-geometric)
 * ATS-friendly: One-column, no tables, no icons, standard headings
 * Bold dark section headers, high contrast, angular feel
 */
export default function SharpGeometricTemplate({ data, sectionOrder, watermark = false }: TemplateProps) {
  ...
  const sectionMap: Record<ResumeSectionKey, React.ReactNode> = {
    summary: summary ? (
      <section className="mb-6">
        <div className="bg-slate-800 -mx-2 px-2 py-1.5 mb-3">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">Profile</h2>
        </div>
    ...
    education: education.length > 0 ? (
      <section className="mb-6">
        <div className="bg-slate-800 -mx-2 px-2 py-1.5 mb-3">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">Education</h2>
        </div>
    ...
    experience: experience.length > 0 ? (
      <section className="mb-6">
        <div className="bg-slate-800 -mx-2 px-2 py-1.5 mb-3">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">Experience</h2>
        </div>
        <div className="space-y-4">
          {experience.map((exp) => (
    ...
    projects: projects.length > 0 ? (
      <section className="mb-6">
        <div className="bg-slate-800 -mx-2 px-2 py-1.5 mb-3">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">Projects</h2>
        </div>
        <div className="space-y-4">
    ...
    skills: (skills.technical.length > 0 || skills.soft.length > 0 || (skills.languages && skills.languages.length > 0)) ? (
      <section className="mb-6">
        <div className="bg-slate-800 -mx-2 px-2 py-1.5 mb-3">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">Skills</h2>
        </div>
    ...
    certifications: certifications && certifications.length > 0 ? (
      <section className="mb-6">
        <div className="bg-slate-800 -mx-2 px-2 py-1.5 mb-3">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">Certifications</h2>
        </div>
  ...
  return (
    <div className="max-w-[210mm] mx-auto bg-white p-8 shadow-lg relative print:shadow-none">
      ...
      <header className="mb-6">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">{personal.name}</h1>
        <div className="bg-slate-800 -mx-8 px-8 py-2">
