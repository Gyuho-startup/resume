...
/**
 * Navy Executive Template (slug: navy-executive)
 * ATS-friendly: One-column, no tables, no icons, standard headings
 * Corporate/finance executive feel with dark navy accents.
 */
export default function NavyExecutiveTemplate({ data, sectionOrder, watermark = false }: TemplateProps) {
  ...
  const sectionMap: Record<ResumeSectionKey, React.ReactNode> = {
    summary: summary ? (
      <section className="mb-5">
        <h2 className="text-xs font-bold uppercase tracking-[0.18em] text-slate-800 border-b border-slate-700 pb-1 mb-3">
  ...
  return (
    <div className="max-w-[210mm] mx-auto bg-white p-8 shadow-lg relative print:shadow-none">
      ...
      {/* Header — always first */}
      <header className="mb-6 pb-4 border-b-4 border-slate-800">
