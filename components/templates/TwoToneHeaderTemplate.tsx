...
/**
 * Two-Tone Header Template (slug: two-tone-header)
 * ATS-friendly: One-column, no tables, no icons, standard headings
 * Dark header band, clean white body.
 */
export default function TwoToneHeaderTemplate({ data, sectionOrder, watermark = false }: TemplateProps) {
  ...
  const sectionMap: Record<ResumeSectionKey, React.ReactNode> = {
    summary: summary ? (
      <section className="mb-5">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-700 border-b border-slate-200 pb-1 mb-3">
  ...
  return (
    <div className="max-w-[210mm] mx-auto bg-white p-8 shadow-lg relative print:shadow-none">
      ...
      {/* Header — dark band, always first */}
      <header className="bg-slate-900 -mx-8 -mt-8 px-8 py-6 mb-6">
