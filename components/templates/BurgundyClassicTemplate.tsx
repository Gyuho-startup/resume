...
/**
 * Burgundy Classic Template (slug: burgundy-classic)
 * ATS-friendly: One-column, no tables, no icons, standard headings
 * Rich burgundy/wine tones. Law, finance, traditional.
 */
export default function BurgundyClassicTemplate({ data, sectionOrder, watermark = false }: TemplateProps) {
  ...
  const sectionMap: Record<ResumeSectionKey, React.ReactNode> = {
    summary: summary ? (
      <section className="mb-5">
        <h2 className="text-base font-bold text-red-900 border-b border-red-200 pb-1 mb-3">
  ...
  return (
    <div className="max-w-[210mm] mx-auto bg-white p-8 shadow-lg relative print:shadow-none">
      ...
      {/* Header — always first */}
      <header className="mb-6 pb-4 border-b-2 border-red-900">
        <h1 className="text-3xl font-bold text-red-900 mb-1">{personal.name}</h1>
