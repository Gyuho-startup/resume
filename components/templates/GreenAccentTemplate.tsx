...
/**
 * Green Accent Template (slug: green-accent)
 * ATS-friendly: One-column, no tables, no icons, standard headings
 * Fresh green accent. Healthcare, sustainability, creative.
 */
export default function GreenAccentTemplate({ data, sectionOrder, watermark = false }: TemplateProps) {
  ...
  const sectionMap: Record<ResumeSectionKey, React.ReactNode> = {
    summary: summary ? (
      <section className="mb-5">
        <h2 className="text-base font-bold text-green-700 border-b border-green-200 pb-1 mb-3">
  ...
  return (
    <div className="max-w-[210mm] mx-auto bg-white p-8 shadow-lg relative print:shadow-none">
      ...
      <header className="mb-6">
        <h1 className="text-3xl font-bold text-green-800 mb-1">{personal.name}</h1>
        <div className="border-b-2 border-green-500 mb-2" />
